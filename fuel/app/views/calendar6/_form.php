<?php echo Form::open(array("class"=>"form-horizontal")); ?>
	...
	<fieldset>
		...
		<div class="form-group ymd">
			<?php echo Form::label('年', 'year', array('class'=>'control-label')); ?><div class="frm-required">※必須</div>
				<?php echo Form::input('year', Input::post('year', isset($calendar6) ? $calendar6->year : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'例）2018','autocomplete'=>'organization', 'maxlength'=>'4')); ?>
		</div>	
		<div class="form-group ymd">
			<?php echo Form::label('月', 'month', array('class'=>'control-label')); ?><div class="frm-required">※必須</div>

				<?php echo Form::input('month', Input::post('month', isset($calendar6) ? $calendar6->month : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'例）1, 12','maxlength'=>'2')); ?>
		</div>	
		<div class="form-group ymd">
			<?php echo Form::label('日付', 'day', array('class'=>'control-label')); ?><div class="frm-required">※必須</div>
				<?php echo Form::input('day', Input::post('day', isset($calendar6) ? $calendar6->day : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'例）1, 31','maxlength'=>'2')); ?>
		</div>
	...
	<?php $siteibi = Session::get('siteibi');?>
	<?php echo "$siteibi";?>
	<?php Session::delete('siteibi');?>
<?php echo Form::close(); ?>